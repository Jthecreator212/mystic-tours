    ...
    <div className="relative h-[100vh] min-h-[600px]">
      <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center pt-16">
        <div className="max-w-3xl text-center">
          ...
          <div className="bg-[#1a5d1a]/40 backdrop-blur-sm p-6 rounded-lg border-l-4 border-[#e9b824] mb-8 transform hover:scale-105 transition-all duration-300">
            <p className="text-xl md:text-2xl text-[#f8ede3]">
