  ...
  return (
    <div className="relative h-[100vh] min-h-[600px]">
      <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center pt-16">
        <div className="max-w-2xl ml-0 md:ml-24 lg:ml-48">
          ...
          <div className="bg-[#1a5d1a]/40 backdrop-blur-sm p-4 rounded-lg border-l-4 border-[#e9b824] mb-8 transform hover:scale-105 transition-all duration-300 w-[90%] mx-auto">
            <div className="relative h-16 overflow-hidden">
              {phrases.map((phrase, index) => (
                <div
                  key={index}
                  className={`absolute top-0 left-0 w-full transition-all duration-500 flex items-start ${
            ...
            <p className="text-lg text-[#f8ede3] ml-7">
